...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isMac) {
        // Mac: use GitHub release download
        primaryUrl = macDownloadUrl;
        fileName = 'Long Home Confirmation Helper-1.0.0.dmg';
        osName = 'Mac';
    } else if (isWindows) {
    ...
    function handleDownload(e) {
        ...
        downloadFile(primaryUrl, fileName)
            ...
            .catch(() => {
                // Primary failed - show error (no fallback for Mac, Windows should always work locally)
